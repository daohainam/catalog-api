    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariantDimentionValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VariantDimentionValues_DimensionValues_DimensionValueId",
                        column: x => x.DimensionValueId,
                        principalTable: "DimensionValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VariantDimentionValues_Dimensions_DimensionId",
                        column: x => x.DimensionId,
                        principalTable: "Dimensions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VariantDimentionValues_Variants_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantDimentionValues_DimensionId",
                table: "VariantDimentionValues",
                column: "DimensionId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantDimentionValues_DimensionValueId",
                table: "VariantDimentionValues",
                column: "DimensionValueId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantDimentionValues_VariantId",
                table: "VariantDimentionValues",
                column: "VariantId");

            migrationBuilder.CreateIndex(
                name: "IX_Variants_AvailableStock",
                table: "Variants",
